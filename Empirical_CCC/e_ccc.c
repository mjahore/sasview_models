...
static double Iq(double q, double I0, double I1, double sld_c, double sld1, double sld2, double sld_solvent, double R, double rc, double poly_sig, double rg1, double rg2, double nu1, double nu2) {
